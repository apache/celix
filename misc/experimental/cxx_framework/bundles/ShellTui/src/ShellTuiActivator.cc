...
//        std::unique_ptr<celix::ComponentManager<celix::bundle::ShellTui>> createMng(const std::shared_ptr<celix::BundleContext>& ctx) {
//            auto mng = std::unique_ptr<celix::ComponentManager<celix::bundle::ShellTui>>{
//                    new celix::ComponentManager<celix::bundle::ShellTui>{ctx->bundle(), ctx->registry(), std::make_shared<celix::bundle::ShellTui>(&std::cout, &std::cerr)}};
//
//            using namespace std::placeholders;
//            mng->addServiceDependency<celix::IShell>()
//                    .setCallbacks(&celix::bundle::ShellTui::setShell);
//            mng->enable();
//            return mng;
//        }
    private:
        celix::bundle::ShellTui tui{&std::cout, &std::cerr};
        celix::ServiceTracker trk{};
//        std::unique_ptr<celix::ComponentManager<celix::bundle::ShellTui>> shellTuiMng;
    };
