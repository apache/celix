...
Apache Celix is an implementation of the OSGi specification adapted to C and C++ (C++17). 
...
TODO refactor use with a small C and C++ example and for the rest see Intro, Bundles, Service and/or Components
