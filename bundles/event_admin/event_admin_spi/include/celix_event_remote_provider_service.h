...
#ifndef CELIX_EVENT_REMOTE_PROVIDER_SERVICE_H
#define CELIX_EVENT_REMOTE_PROVIDER_SERVICE_H
#ifdef __cplusplus
extern "C" {
#endif
...
/**
 * @brief The Event Remote Provider service name
 */
#define CELIX_EVENT_REMOTE_PROVIDER_SERVICE_NAME "celix_event_remote_provider_service"

/**
 * @brief The Event Remote Provider service version
 */
#define CELIX_EVENT_REMOTE_PROVIDER_SERVICE_VERSION "1.0.0"
#define CELIX_EVENT_REMOTE_PROVIDER_SERVICE_USE_RANGE "[1.0.0,2)"
...
#endif //CELIX_EVENT_REMOTE_PROVIDER_SERVICE_H
