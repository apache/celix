...
static celix_status_t calcShell_start(calc_shell_activator_t *activator, celix_bundle_context_t *ctx) {
    ...
    activator->addCmdSvcId = celix_bundleContext_registerServiceAsync(ctx, &activator->addCmd, CELIX_SHELL_COMMAND_SERVICE_NAME, props);
    ...
    activator->subCmdSvcId = celix_bundleContext_registerServiceAsync(ctx, &activator->subCmd, CELIX_SHELL_COMMAND_SERVICE_NAME, props);
    ...
    activator->sqrtCmdSvcId = celix_bundleContext_registerServiceAsync(ctx, &activator->sqrtCmd, CELIX_SHELL_COMMAND_SERVICE_NAME, props);
